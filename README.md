...
1. **Mint MEAT** – MEAT hanya dicetak melalui `mintSubtype()` oleh kontrak yang telah diberi otorisasi seperti hook pembakaran NFT. Saat kontrak dideploy, pemilik otomatis diberi hak minter dan `mintSubtype` langsung mencetak 1000 `GOATMEAT`.
