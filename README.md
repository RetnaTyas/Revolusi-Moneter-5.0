...
The `artifacts/` folder is generated by Hardhat and the CosmWasm build script but is not stored in Git. Populate it locally using the Hardhat configuration in `hardhat.config.js` or the build script:
